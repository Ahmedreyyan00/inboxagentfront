    ...
    >
      <div className="bg-white rounded-t-xl sm:rounded-xl shadow-xl w-full max-w-2xl p-4 sm:p-8 relative max-h-[90vh] overflow-y-auto">
        ...
        >
          ...
          <h2 className="text-xl sm:text-2xl mb-2 text-center">
            {isConnected
              ? t.gmailConnectionStatus
              : t.securelyConnectYourGmail}
          </h2>
          ...
          <div className="mb-6">
            ...
            <div className="space-y-3">
              {emails.map((email, index) => {
                const accountInfo = googleAccounts?.find((acc) => acc.email === email);
      ...
      {!mailBoxLimitReached &&  <button
        ...
        >
          ...
          <span>
            {isConnected ? "Connect New Gmail Account" : "Authorize with Google"}
          </span>
        </button>}
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-orange-700 mt-1">
                  ...
                  Please upgrade your subscription to connect more Gmail accounts.
                </p>
              </div>
            </div>
          </div>
